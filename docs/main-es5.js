...
var NodeListComponent = /** @class */ (function () {
    ...
    NodeListComponent.prototype.addChildNode = function (node) {
        this.nodeList.push(node);
    };
    NodeListComponent.prototype.editorExpandEventHandler = function (node) {
...
var ArrowComponent = /** @class */ (function () {
    ...
    ArrowComponent.prototype.findShortestArrowWay = function () {
...
var NodeComponent = /** @class */ (function () {
    ...
    NodeComponent.prototype.onDragEnded = function (event) {
        var position = event.source.getFreeDragPosition();
        this.node.x = position.x;
        this.node.y = position.y;
    };
    NodeComponent.prototype.addChildNode = function () {
        var node = {
            text: "new node",
            title: "new node",
            childNodes: [],
    ...
    NodeComponent.prototype.expandEditor = function () {
...
var PlaygroundComponent = /** @class */ (function () {
    ...
    PlaygroundComponent.prototype.editorExpandEventHandler = function (node) {
        console.log(node);
        this.editedNode = node;
    };
    PlaygroundComponent.prototype.cleanPlayground = function () {
        var node = {
            text: "some text",
            title: "some title",
            childNodes: [],
